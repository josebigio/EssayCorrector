...
// __nullable added for Swift issue rdar://23285766 - remove with Xcode 8.
PSPDF_EXPORT void PSPDFSetLocalizationBlock(NSString *__nullable (^_Nullable localizationBlock)(NSString *_Nullable stringToLocalize));
