...
- (NSArray<__kindof PSPDFAnnotation *> *)annotationsForPage:(NSUInteger)page type:(PSPDFAnnotationType)type;
...
/// Set custom render options (see PSPDFRenderManager.h for options)
...
@property (nonatomic, copy) NSDictionary<NSString *, id> *renderOptions;
...
/// Override if you want custom render options for a specific page.
/// Simply returns the content of `renderOptions` by default.
- (NSDictionary<NSString *, id> *)renderOptionsForPage:(NSUInteger)page;
