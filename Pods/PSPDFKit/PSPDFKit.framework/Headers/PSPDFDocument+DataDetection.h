...
- (NSDictionary<NSString *, id> *)objectsAtPDFPoint:(CGPoint)pdfPoint page:(NSUInteger)page options:(NSDictionary<NSString *, NSNumber *> *)options;
...
///
/// This method is thread safe.
- (NSDictionary<NSString *, id> *)objectsAtPDFRect:(CGRect)pdfRect page:(NSUInteger)page options:(NSDictionary<NSString *, NSNumber *> *)options;
