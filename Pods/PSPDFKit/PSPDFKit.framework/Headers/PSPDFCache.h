...
- (nullable UIImage *)imageFromDocument:(nullable PSPDFDocument *)document page:(NSUInteger)page size:(CGSize)size options:(PSPDFCacheOptions)options completionBlock:(nullable void(^)(UIImage *image, PSPDFDocument *document, NSUInteger page, CGSize size))completionBlock;
